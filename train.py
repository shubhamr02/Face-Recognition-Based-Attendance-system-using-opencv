...
sys.path.append('C:/Users/Akshay/Anaconda3/Lib/site-packages')
window = tk.Tk()
...
lbl = tk.Label(window, text="Enter Roll No & Div",width=20  ,height=2  ,fg="red"  ,bg="yellow" ,font=('times', 15, ' bold ') ) 
